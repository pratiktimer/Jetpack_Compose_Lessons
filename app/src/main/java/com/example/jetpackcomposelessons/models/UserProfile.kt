package com.example.jetpackcomposelessons.models

import com.example.jetpackcomposelessons.R

//data class UserProfile(val userName: String, val isActive: Boolean,val ImageID: Int)
//
//val userProfileList = arrayListOf<UserProfile>(
//    UserProfile(userName = "Pratik Banawalkar", isActive = true, R.drawable.profile_picture),
//    UserProfile(userName = "Pratik Banawalkar", isActive = true, R.drawable.profile_picture),
//    UserProfile(userName = "Pratik Banawalkar", isActive = true, R.drawable.profile_picture),
//    UserProfile(userName = "Pratik Banawalkar", isActive = true, R.drawable.profile_picture),
//    UserProfile(userName = "Pratik Banawalkar", isActive = true, R.drawable.profile_picture),
